...
import 'package:amap_special/src/location/model/location.dart';
import 'package:amap_special/src/location/model/location_client_options.dart';
import 'package:flutter/services.dart';

class AMapLocation {
  static AMapLocation _instance;

  static const _locationChannel = MethodChannel('foton/location');
  static const _locationEventChannel = EventChannel('foton/location_event');
